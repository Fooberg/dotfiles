...
set(0, '@lsp.typemod.namespace.library.rust', { fg = colors.blue }) 
set(0, '@lsp.typemod.enum.declaration.rust', { fg = colors.red }) 
set(0, '@lsp.typemod.struct.declaration.rust', { fg = colors.red }) 
